...
The project **multiple-user-ids-actor-filter** is a Bonita actor filter designed for the **Bonita {short-bonita-version} ({short-bonita-tech-version})**  version, specifically to be used with the **ProcessBuilder** project. It is written in `java`.
...
This actor filter validates input strictly to prevent injection attacks:

* Input must be a non-empty List<Long>
* All elements are validated as Long type
* Null values are rejected
* Type checking is performed

== Performance Characteristics

* O(1) validation time (only checks first element type)
* O(n) filter time (returns list as-is)
* No database queries
* Suitable for high-volume task assignments

== Known Limitations

* Only supports Long user IDs
* Requires pre-validation of user existence
* No group or role expansion
...
* **Project Site Homepage**: https://bonitasoft-presales.github.io/multiple-user-ids-actor-filter/
* **Javadoc API Documentation**: https://bonitasoft-presales.github.io/multiple-user-ids-actor-filter/apidocs/index.html
* **JaCoCo Code Coverage Report**: https://bonitasoft-presales.github.io/multiple-user-ids-actor-filter/jacoco/index.html
...
== Links
  * **Project homepage**: https://github.com/bonitasoft-presales/multiple-user-ids-actor-filter
  * **Repository**: https://github.com/bonitasoft-presales/multiple-user-ids-actor-filter.git
  * **Issue tracker**: https://github.com/bonitasoft-presales/multiple-user-ids-actor-filter/issues
  * **Project Site Homepage**: https://bonitasoft-presales.github.io/multiple-user-ids-actor-filter/
  * **Javadoc API Documentation**: https://bonitasoft-presales.github.io/multiple-user-ids-actor-filter/apidocs/index.html
  * **JaCoCo Code Coverage Report**: https://bonitasoft-presales.github.io/multiple-user-ids-actor-filter/jacoco/index.html
