...
:java-version: 17
= connector-rabbitmq-consume

The project **connector-rabbitmq-consume** is a Bonita Connector for **Bonita {short-bonita-version}**  **Community** version written in `java` language.
...
[source,bash]
----
git clone https://your.github.com/connector-rabbitmq-consume.git
cd connector-rabbitmq-consume/
./mwnw package
----

The build should produce a jar archive under the `target/` folder named `connector-rabbitmq-consume-1.0-SNAPSHOT.jar`
